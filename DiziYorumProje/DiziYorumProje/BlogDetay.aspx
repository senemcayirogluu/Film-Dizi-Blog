		  ...
		  <div class="col-md-8 single-main">				 
			  <div class="single-grid">
				  <asp:Repeater ID="Repeater1" runat="server">
					  <ItemTemplate>
						  <img src="<%#Eval("BLOGGORSEL")%>" alt="" style="height: 250px; width: 450px; margin-bottom: 20px"/>
			  ...
			  <asp:Repeater ID="Repeater2" runat="server">
				  <ItemTemplate>
		              ...
		              <div class="desc">
		              <p style="font-weight:bolder"><%#Eval("KULLANICIADI")%>:</p> <p><%#Eval("YORUMICERIK")%></p>
		              </div>
			  ...
			  <div class="content-form">
					...
					<form runat="server">
						...
						<asp:Button ID="Button1" runat="server" Text="Yorum Gönder" OnClick="Button1_Click"/>
				   </form>
			</div>
		  </div>
   </div>
